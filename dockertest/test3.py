...
# incruit_contents > div.section_layout > div.n_job_list_default > div.n_job_list_table_a.list_full_default > table > tbody > tr:nth-child(1) > td:nth-child(2) > div > span.accent > a
        title_data=soup.tbody
        datas = title_data.select(f"tr:nth-of-type({i})")
